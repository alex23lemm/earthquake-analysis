...
In May and June 2014 several earthquakes struck the region east of Darmstadt (Germany). In this report we will use the earthquake data provided by the [Bundesanstalt fuer Geowissenschaften und Rohstoffe (BGR)][BGR] and the `ggmap` package to create different maps. 
